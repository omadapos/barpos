  ...
  return (
    <div className="login-app-root relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden p-4">
      ...
      <button
        ...
        className="fixed top-6 right-6 z-[50] flex items-center gap-2 rounded-2xl border border-slate-200/80 bg-white/75 px-4 py-2 text-[var(--text)] shadow-md shadow-slate-900/6 backdrop-blur-md transition-all hover:bg-white hover:shadow-lg active:scale-90"
      ...
      {window.electronEnv?.closeWindow && (
        <button
          ...
          className="fixed top-6 left-6 z-[50] flex items-center gap-2 rounded-2xl border border-slate-200/80 bg-white/75 px-4 py-2 text-[var(--text)] shadow-md shadow-slate-900/6 backdrop-blur-md transition-all hover:border-red-200 hover:bg-red-50 hover:text-[var(--red)] active:scale-90"
      ...
      <div
        className={`w-full max-w-md rounded-[2rem] border border-white/80 bg-white/50 p-8 shadow-xl shadow-slate-900/10 backdrop-blur-2xl transition-all sm:p-10 ${
          shake ? 'shake' : ''
        }`}
      >
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm font-medium uppercase tracking-widest text-[var(--text2)]">
            Acceso Personal
          </p>
        </div>
      ...
      <div className="mt-8 flex flex-col items-center gap-1 opacity-80">
        ...
        <p className="text-[9px] font-bold font-mono text-[var(--text3)]">
