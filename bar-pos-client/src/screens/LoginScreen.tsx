...
export function LoginScreen() {
  ...
  const keyClass =
    'flex h-20 w-24 items-center justify-center rounded-2xl border border-white/70 bg-white/80 text-2xl font-black text-[var(--text)] shadow-sm shadow-black/5 transition-all hover:bg-white hover:shadow-md active:scale-95';
  ...
  return (
    <div className="login-app-root relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-[#10151b] p-4">
      ...
      <div
        className={`w-full max-w-md rounded-[2rem] border border-white/70 bg-[var(--green-pale)]/95 p-8 shadow-2xl shadow-black/25 backdrop-blur-sm transition-all sm:p-10 ${
          shake ? 'shake' : ''
        }`}
      >
          ...
          <>
            ...
            <div className="mx-auto grid w-fit grid-cols-3 gap-4">
              ...
              <button
                ...
                className="flex h-20 w-24 items-center justify-center rounded-2xl border border-white/70 bg-white/80 text-[var(--red)] shadow-sm shadow-black/5 transition-all hover:bg-[var(--red-pale)] active:scale-95"
              >
